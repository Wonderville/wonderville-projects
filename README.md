...
- `donate.liquid` produces `donate.html` & is visible [here](http://localhost:8080/donate).
- `programs/internship.liquid` produces `programs/internship.html` & is visible [here](http://localhost:8080/programs/internship).
